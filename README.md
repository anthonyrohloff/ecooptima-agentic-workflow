...
3. Set your OpenAI API key in the terminal with:
...
2. Everything is a branch. No code changes should be made on the main branch. Anytime you want to modify the code, use:

`git checkout -b [your-branch-name]`

Then, when your code is ready to be merged, perform the following process:
